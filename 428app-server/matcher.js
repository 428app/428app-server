 ...
 * 1) Match users to classrooms, 
 * 2) Transfer users to their new classrooms, 
 * 3) Assign new questions once a day, 
 * 4) Assign superlatives to existing classrooms
 * 
 * NOTE: This file is not called on the server. The "matcher-*" files are the ones being called by 
 * the cron jobs on the server. Refer to cronjobs.txt for more info as to how they are called.
 * 
 * To run, just call one of the main functions stated below, then run: node matcher.js
 */
...
var DAYS_TO_GENERATE_CLASSROOM = 1 // TODO: New classroom every day, change back to 7 before production
